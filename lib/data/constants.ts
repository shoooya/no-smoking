import { HealthMilestone, Achievement, CopingStrategy, Reason } from '@/types';
...
export const achievements: Achievement[] = [
  { id: 'first-hour', minutes: 60, condition: 'time', name: '最初の1時間', icon: '⭐' },
  { id: 'first-day', minutes: 1440, condition: 'time', name: '1日達成', icon: '🌟' },
  { id: 'three-days', minutes: 4320, condition: 'time', name: '3日達成', icon: '✨' },
  { id: 'one-week', minutes: 10080, condition: 'time', name: '1週間達成', icon: '🎖️' },
  { id: 'two-weeks', minutes: 20160, condition: 'time', name: '2週間達成', icon: '🏅' },
  { id: 'one-month', minutes: 43200, condition: 'time', name: '1ヶ月達成', icon: '🥇' },
  { id: 'three-months', minutes: 129600, condition: 'time', name: '3ヶ月達成', icon: '👑' },
  { id: 'six-months', minutes: 259200, condition: 'time', name: '6ヶ月達成', icon: '💎' },
  { id: 'one-year', minutes: 525600, condition: 'time', name: '1年達成', icon: '🏆' },
